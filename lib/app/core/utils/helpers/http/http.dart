import 'package:master_champions/app/core/utils/helpers/http/http_result.dart';
import 'package:master_champions/app/core/utils/helpers/http/parse_response.dart';
import 'package:master_champions/app/core/utils/helpers/http/send_request.dart';
...
class Http {
  ...
  Http({this.baseUrl = 'http://192.168.1.33/api_master_champions/v1/'});
